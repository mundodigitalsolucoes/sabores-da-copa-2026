...
import { marketingBootstrapScript, PLACEHOLDER_IDS } from "@/lib/marketing";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Villa Rotisseria" },
      { name: "author", content: "Villa Rotisseria" },
    ],
    links: [
    ...
    scripts: [
      { children: marketingBootstrapScript },
      {
      ...
      <body>
        <noscript>
          <iframe
            ...
            src={`https://www.googletagmanager.com/ns.html?id=${PLACEHOLDER_IDS.gtm}`}
            height="0"
            width="0"
